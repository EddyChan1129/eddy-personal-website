...
const handleClickNavLink = (e: MouseEvent<HTMLAnchorElement>) => {
  e.preventDefault();
      ...
      <div className="container">
        <div className="section">
          ...
          <div className="grid md:grid-cols-3 md:items-center">
            <div className="md:col-span-2">
              <h2
                ...
                ref={scope}
              >
                Enough talk, Let&apos;s make something great toghether.
              </h2>
              <Button
                className="mt-8"
                variant="secondary"
            ...
            <div>
              <nav className="flex flex-col md:items-end gap-8 mt-16 md:mt-0">
                {navItems.map(({ href, label }) => (
                  <a href={href} key={label} onClick={handleClickNavLink}>
                    <Button variant="text" className="text-lg lg:text-xl">
                      {label}
                    </Button>
                  </a>
                ))}
          ...
          <p className="py-16 text-white/30 text-sm">
            Copyright &copy; Eddy CHAN &bull; All rights reserved
          </p>
        </div>
      </div>
    </footer>

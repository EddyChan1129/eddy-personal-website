    ...
    <section className="section">
      ...
      <div className="container">
            ...
            index === testimonialIndex && (
              <div key={name} className="grid md:grid-cols-5 md:gap-8 lg:gap-16 md:items-center">
                ...
                <blockquote className="col-span-3">
                  ...
                  <cite className="mt-4 md:mt-8  not-italic md:text-lg lg:text-xl block ">
        ...
        <div className="flex gap-4 mt-6 lg:mt-10">
          <button className="border border-stone-400 rounded-full inline-flex items-center justify-center size-11">
